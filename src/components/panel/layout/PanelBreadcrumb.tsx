...
const pageNames: Record<PanelVariant, Array<{ prefix: string; label: string }>> = {
  admin: [
    ...
    { prefix: '/admin/jadwal-instalasi', label: 'Jadwal Layanan' },
    { prefix: '/admin/landing', label: 'Landing Page' },
    { prefix: '/admin/tiket', label: 'Tiket Layanan' },
    { prefix: '/admin/komplain', label: 'Tiket Layanan' },
  ...
  customer: [
    ...
    { prefix: '/dashboard/tiket', label: 'Tiket Layanan' },
    { prefix: '/dashboard/komplain', label: 'Tiket Layanan' },
